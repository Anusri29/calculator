...
btnSub = Button(cal,padx=16,bd=8, fg='black',font= ('arial',20,'bold'),text="-").grid(row=2,column=3)
...
btnMult = Button(cal,padx=16,bd=8, fg='black',font= ('arial',20,'bold'),text="*").grid(row=3,column=3)

btnClear = Button(cal,padx=16,bd=8, fg='black',font= ('arial',20,'bold'),text="C").grid(row=4,column=0)
btnZero = Button(cal,padx=16,bd=8, fg='black',font= ('arial',20,'bold'),text="0").grid(row=4,column=1)
btnEqual = Button(cal,padx=16,bd=8, fg='black',font= ('arial',20,'bold'),text="=").grid(row=4,column=2)
btnDiv = Button(cal,padx=16,bd=8, fg='black',font= ('arial',20,'bold'),text="/").grid(row=4,column=3)
